...
function App() {
    ...
    return ( 
        <div className = "App" >
            ...
            <button class='glowing-btn' onClick={() => window.location.reload()}><span class='glowing-txt'>Play<span class='faulty-letter'>!</span>Now</span></button>
            ...
            <Link to="/"><button class='glowing-btn'><span class='glowing-txt'>Go<span class='faulty-letter'>To</span>Home Page</span></button></Link>
