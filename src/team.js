...
function Team() {
  return (
    ...
    <h3>ZEMOS</h3>
    <br/>
	<p style={{marginLeft:100,marginRight:100}}> This is team Grotesque. We students from IIIT Naya Raipur present to you "ZEMOS". An application takes hand gesture (through webcam of your laptop) as an input to move a 3D character model in a 3D environment build in Unity 3D.
